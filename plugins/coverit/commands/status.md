...
```
No coverit.json found. Run /coverit:scan to scan and analyze the codebase first.
```
And stop.
...
- If no coverit.json exists: "Tip: Run `/coverit:scan` to create the quality manifest, then `/coverit:cover` to generate tests."
